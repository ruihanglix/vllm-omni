...
class SiglipNaViTWrapper(nn.Module):
    ...
    def patch_embed_weight(self):
        return self.vision_model.embeddings.patch_embedding.weight

    @property
    def patch_embed_bias(self):
        return self.vision_model.embeddings.patch_embedding.bias
...
class BagelPipeline(nn.Module):
    ...
    def __init__(self, *, od_config: OmniDiffusionConfig, prefix: str = ""):
        ...
        # Match AR-stage overrides: checkpoint has 26 layers, not 27
